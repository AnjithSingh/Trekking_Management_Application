...
first_names = ["Aarav", "Aditya", "Rahul", "Karthik", "Rohan", "Amit", "Vikram", "Siddharth", "Manish", "Arjun", "Kiran", "Nikhil", "Priya", "Anjali", "Sneha", "Kavya", "Neha", "Pooja", "Riya", "Shruti", "Divya", "Swati", "Meera", "Aditi", "Isha"]
last_names = ["Sharma", "Singh", "Patel", "Reddy", "Kumar", "Rao", "Gupta", "Deshmukh", "Joshi", "Iyer", "Nair", "Das", "Verma", "Chauhan", "Yadav", "Menon", "Bose", "Mehta", "Mishra", "Pandey", "Chaudhary", "Kapoor", "Bhat", "Pillai", "Garg"]

trek_names = ["Kedarkantha", "Roopkund", "Valley of Flowers", "Triund", "Hampta Pass", "Kashmir Great Lakes", "Goechala", "Sandakphu", "Har Ki Dun", "Chadar Trek", "Bhrigu Lake", "Kudremukh", "Kumara Parvatha", "Rajmachi Fort"]
locations = ["Uttarakhand", "Himachal Pradesh", "Sikkim", "Jammu & Kashmir", "West Bengal", "Ladakh", "Karnataka", "Maharashtra", "Kerala", "Meghalaya"]
...
with app.app_context():
    ...
    for i in range(10):
        ...
        t = Trek(
            ...
            price=round(random.uniform(2500, 25000), 2), # Adjusted to better reflect INR pricing
